...
export default function OurPartnersFilter() {
  ...
  const currentPartnerType = searchParams.get("partner_type") || "";
  const currentSortOrder = searchParams.get("sort_order") || "";
  const hasActiveFilters = currentSearch !== "" || currentStatus !== "" || currentPartnerType !== "" || currentSortOrder !== "";
          ...
          render={({ field }) => (
            <Select
              onValueChange={(value) => {
                ...
                handleSelectChange("partner_type")(value);
              }}
              value={field.value}
            >
