      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-4">
          ...
          <div>
            ...
            <div className="mt-6">
              <p className="text-sm white-color mb-2">Follow us on:</p>
              <div className="flex gap-3">
                <Link href="#" className=" white-color">
                  <Facebook size={20} />
                </Link>
                <Link href="#" className=" white-color">
                  <Linkedin size={20} />
          ...
          <div className="ps-0 sm:ps-4">
            <h3 className="font-semibold text-lg mb-4 white-color">
              Important Links
            </h3>
            <ul className="space-y-2">
              {importantLinks.map((link) => (
                <li key={link.name}>
                  <a
                    href={link.href}
                    className="text-sm text-primary-foreground/80  white-color"
                  >
                    {link.name}
                  </a>
                </li>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm white-color">
        ...
        <div className="flex justify-center text-base white-color pt-4 border-t border-primary-foreground/20">
